 ...
 * @author Admin
 */
@WebServlet(name = "GetAdminStatisticOwnerController", urlPatterns = {"/GetAdminStatisticOwnerController"})
public class GetAdminStatisticOwnerController extends HttpServlet {

    private final String WEBOWNER_HOME_PAGE = "HomeWebowner.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        ...
        try {
            System.out.println("Admin Servlet: " + request.getServletPath());
