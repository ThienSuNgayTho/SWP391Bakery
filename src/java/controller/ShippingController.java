...
public class ShippingController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String city = Utilities.unAccent(request.getParameter("City"));
            String district = Utilities.unAccent(request.getParameter("District"));
            String ward = Utilities.unAccent(request.getParameter("Ward"));
            String street = Utilities.unAccent(request.getParameter("Street"));
            String address = street + ", " + ward + ", " + district + ", " + city;
            log(request.getParameter("City"));
