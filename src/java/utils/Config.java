...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8084/bakeryShopping/Purchase";
    public static String vnp_TmnCode = "TQYGLNJO";
    public static String vnp_HashSecret = "RKFOUXLJALTXQCYLWFVCWCNSNGHILJVN";
